...
router.post('/api/v1/list-buissness/upload-image', upload.single('image'), async (req, res) => {
    if (!req.file) {
 ...
 *@validation {postman} tested by post postman
 */
router.get("/api/vi/list-business/get/by/subcategory/:subcategory", getBusinessListBySubCategory);
 ...
 *@validation {postman} tested by post postman
 */
router.get("/api/vi/list-business/manage/get/search/by/search", searchBusinessListForManage);
